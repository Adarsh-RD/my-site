...
export function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Production anomaly detection system built at Infosys using Apache Kafka and Python, reducing false-positive alert rates by 34% across monitoring dashboards. Optimized BigQuery SQL queries cutting report generation from 12s to 3.8s.',
      tags: ['Python', 'Apache Kafka', 'BigQuery', 'SQL'],
      category: 'backend',
      link: '#',
      github: 'https://github.com/Adarsh-RD',
      color: '#c41e3a',
